function renderApp() {
  ...
  app.innerHTML = `<div class="layout">
    <div class="hero">
      ...
      <div class="row"><span class="tag ${isAdmin() ? 'green' : 'blue'}">${roleName(state.me?.role)}</span><select id="childSelect">${childOptions}</select><button class="secondary" id="logoutBtn">退出</button></div>
    </div>
    <div class="grid">

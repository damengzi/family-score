...
const i18n = {
  ...
  en: {
    appTitle:'Family Moral Score', profile:'Profile', overview:'Overview', auditCenter:'Audit Center', growthReport:'Growth Report', guide:'Score Guide', detail:'Score Records', score:'Score', tasks:'Today Tasks', rewards:'Rewards',

...
func (r *Repository) Migrate(ctx context.Context) error {
	stmts := []string{
		...
		`CREATE TABLE IF NOT EXISTS task_templates (id INTEGER PRIMARY KEY AUTOINCREMENT, family_id INTEGER NOT NULL, task_name VARCHAR(128) NOT NULL, task_type VARCHAR(32) NOT NULL, category VARCHAR(32) NOT NULL, subject VARCHAR(32) NOT NULL DEFAULT 'GENERAL', content VARCHAR(2048) NOT NULL DEFAULT '', question_type VARCHAR(32) NOT NULL DEFAULT 'NONE', answer VARCHAR(512) NOT NULL DEFAULT '', score_value INTEGER NOT NULL, target_account VARCHAR(32) NOT NULL, due_time VARCHAR(5) NOT NULL DEFAULT '', need_parent_confirm INTEGER NOT NULL DEFAULT 1, daily_limit INTEGER NOT NULL DEFAULT 1, weekly_limit INTEGER NOT NULL DEFAULT 0, enabled INTEGER NOT NULL DEFAULT 1, description VARCHAR(512) NOT NULL DEFAULT '', created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP);`,
		`CREATE TABLE IF NOT EXISTS task_instances (id INTEGER PRIMARY KEY AUTOINCREMENT, child_id INTEGER NOT NULL, template_id INTEGER NULL, task_name VARCHAR(128) NOT NULL, task_type VARCHAR(32) NOT NULL, category VARCHAR(32) NOT NULL, subject VARCHAR(32) NOT NULL DEFAULT 'GENERAL', content VARCHAR(2048) NOT NULL DEFAULT '', question_type VARCHAR(32) NOT NULL DEFAULT 'NONE', answer VARCHAR(512) NOT NULL DEFAULT '', score_value INTEGER NOT NULL, target_account VARCHAR(32) NOT NULL, status VARCHAR(32) NOT NULL DEFAULT 'TODO', submit_note VARCHAR(512) NOT NULL DEFAULT '', audit_note VARCHAR(512) NOT NULL DEFAULT '', task_date DATE NOT NULL, due_at TIMESTAMP NULL, submitted_at TIMESTAMP NULL, audited_at TIMESTAMP NULL, created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP);`,
